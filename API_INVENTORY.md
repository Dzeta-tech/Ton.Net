...
### ✅ Completed Modules (v0.1.1)

| Module         | Features                                                              | Version | Tests         |
| -------------- | --------------------------------------------------------------------- | ------- | ------------- |
| **Address**    | Address, ExternalAddress, ContractAddress                             | v0.1.1  | ✅ 6 tests    |
| **BOC**        | BitString, BitReader, BitBuilder, Builder, Slice, Cell, serialization | v0.1.1  | ✅ 15 tests   |
| **Dictionary** | Full hashmap implementation, all key/value types                      | v0.1.1  | ✅ 16 tests   |
| **Tuple**      | TupleReader, TupleBuilder, all item types                             | v0.1.1  | ✅ 25 tests   |
| **TL-B Types** | All 37 types (Messages, Accounts, Transactions, Shards)               | v0.1.1  | ✅ 267 tests  |
| **Contracts**  | IContract, Provider, State, Sender, OpenedContract, ABI               | v0.1.1  | ✅ 5 tests    |
| **HttpClient** | HttpApi, TonClient (v2), TonClient4 (v4), both providers              | v0.1.1  | ✅ 15 tests\* |
| **Utils**      | ToNano, FromNano, CRC16, CRC32C, Base32, GetMethodId                  | v0.1.1  | ✅ 6 tests    |
| **Crypto**     | SHA256, SHA512, PBKDF2, HMAC, Ed25519, Mnemonic                       | v0.1.1  | ✅ 47 tests   |

**Total:** 345 unit tests + 15 integration tests\* = 360 tests | 100% JS SDK parity for implemented features

\*Integration tests marked [Ignore] for CI (require live API endpoint)
...
- [x] TonClient4 v4 wrapper (IContractProvider)
...
- **HTTP Client (v2 & v4) with IContractProvider** ✨ NEW
...
- ✅ **Connecting to TON network (v2 & v4 APIs)** ✨ NEW
- ✅ **Reading contract state & calling get methods** ✨ NEW

Needs wallet contracts for:

- ⏳ Sending transactions (needs wallet contracts)
- ⏳ Creating wallets (needs wallet contract implementations)
- ⏳ Deploying contracts (needs wallet contracts)
- ⏳ Token operations (needs wallet + jetton contracts)

**Next milestone: Wallet Contracts = Unlock transaction sending!**
