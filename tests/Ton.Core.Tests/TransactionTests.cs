...
{
    [Test]
    public void Test_Transaction_ParseAndRoundtrip()
    {
    ...
    [Test]
    public void Test_Transaction_ParseAndHash()
    {
        // Source: https://explorer.toncoin.org/transaction?account=EQCD39VS5jcptHL8vMjEXrzGaRcCVYto7HUn4bpAOg8xqB2N&lt=22901965000001&hash=E9FB666FD65E2D70479C5A2C2EC412AD08D68FCDF57676B3BAA34AADA3C95DB8
        const string boc =
            "";
    ...
    [Test]
    public void Test_Transaction_TickTock()
    {
    ...
    [Test]
    public void Test_Transaction_StateInit()
    {
        const string boc =
    ...
    [Test]
    public void Test_Transaction_WithExternalAddresses()
    {
